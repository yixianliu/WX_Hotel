...
VALUES (NULL, 'CN', '#NAME#', '#TITLE#', '#EMAIL#', '#PHONE#', '#KEYWORDS#', '#SITE_URL#', '#DEVELOPERS#', '#ICP#', '#DESCRIPTION#', '#COPYRIGHT#', #TIME#, #TIME#),
...
VALUES (NULL, 'CN', '中文', 'zh-CN', 'On', 'On', #TIME#, #TIME#),
...
VALUES (NULL, '#DEVELOPERS#', '#TITLE#', '#USERNAME#', NULL, '#SITE_URL#', 'On', 'On', #TIME#, #TIME#);
...
VALUES (NULL, 'S1', '您配偶的生日是?', 'On', #TIME#, #TIME#),
...
VALUES (NULL, 'UP1', 1, 'model', 'product', '产品模型', 'On', 'On', '#TIME#', '#TIME#'),
...
/* 酒店 */
    ...
    */
    ...
    (NULL, 'AuthCoupon5', 5, 'UU1', '/user-coupon/index', 'R15', NULL, 'ACoupon1', '所属用户', NULL, 'CN', 'On', 'On', #TIME#, #TIME#),
    ...
    (NULL, 'AuthOrder3', 3, 'UU1', '/mini-program-order/index', 'R15', NULL, 'AOrder7', '小程序订单列表', NULL, 'CN', 'On', 'On', #TIME#, #TIME#),
    (NULL, 'AuthOrder4', 4, 'UU1', '/mp-order/index', 'R15', NULL, 'AOrder7', '公众号订单列表', NULL, 'CN', 'On', 'On', #TIME#, #TIME#),
